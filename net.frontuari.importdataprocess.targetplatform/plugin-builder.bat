...
call mvn validate -Didempiere.target=net.frontuari.importdataprocess.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=net.frontuari.importdataprocess.p2.targetplatform %DEBUG_MODE%
