...
public class ImportDiscountSchema extends SvrProcess {
			...
			while (rs.next())
			{
				...
				if (M_DiscountSchema_ID <= 0)			//	Insert new Price List
				{
					...
					if(imp.get_ValueAsInt("FTU_ProductClassifications_ID")>0)
						Line.set_ValueOfColumn("FTU_ProductClassifications_ID", imp.get_ValueAsInt("FTU_ProductClassifications_ID"));
					if(imp.get_ValueAsInt("FTU_ProductClassifications2_ID")>0)
						Line.set_ValueOfColumn("FTU_ProductClassifications2_ID", imp.get_ValueAsInt("FTU_ProductClassifications2_ID"));
					if(imp.get_ValueAsInt("FTU_ProductClassifications3_ID")>0)
						Line.set_ValueOfColumn("FTU_ProductClassifications3_ID", imp.get_ValueAsInt("FTU_ProductClassifications3_ID"));
