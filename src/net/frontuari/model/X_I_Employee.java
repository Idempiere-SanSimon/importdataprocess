...
public class X_I_Employee extends PO implements I_I_Employee, I_Persistent 
{
    ...
    {
      StringBuffer sb = new StringBuffer ("X_I_Employee[")
	...
	/** Set Department Value.
		@param DepartmentValue Department Value	  */
	...
	/** Set Import Employee.
		@param I_Employee_ID Import Employee	  */
	public void setI_Employee_ID (int I_Employee_ID)
	{
		if (I_Employee_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_I_Employee_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_I_Employee_ID, Integer.valueOf(I_Employee_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_I_Employee_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set I_Employee_UU.
		@param I_Employee_UU I_Employee_UU	  */
	public void setI_Employee_UU (String I_Employee_UU)
	{
		set_Value (COLUMNNAME_I_Employee_UU, I_Employee_UU);
	}

	/** Get I_Employee_UU.
		@return I_Employee_UU	  */
	public String getI_Employee_UU () 
	{
		return (String)get_Value(COLUMNNAME_I_Employee_UU);
	}
	...
	/** Set Payroll Value.
		@param PayrollValue Payroll Value	  */
